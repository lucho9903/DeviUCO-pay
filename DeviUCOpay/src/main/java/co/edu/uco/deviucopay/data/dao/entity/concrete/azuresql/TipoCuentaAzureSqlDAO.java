...
public class TipoCuentaAzureSqlDAO implements TipoCuentaDAO{
	...
	@Override
	  public final List<TipoCuentaEntity> consultar(final TipoCuentaEntity data) {
        ...
        try (final PreparedStatement sentenciaSqlPreparada = getConexion().prepareStatement(sentenciasSql)) {
            ...
            var mensajeTecnico = "Se ha presentado una excepción de tipo SQLException tratando de realizar la consulta de las tipoCuentas para más detalles revise la excepción raíz presentada..";
